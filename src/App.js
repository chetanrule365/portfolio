    ...
    return (
        <div className="App">
            ...
            <div className="side_link">
                <Bounce>
                    <p>
                        <a href="mailto:chetanrule365@gmail.com">chetanrule365@gmail.com</a>
                    </p>
                </Bounce>
            ...
            <section className="my">
                ...
                <Fade delay={500}>
                    <h2 className="my_prof">I build Web and Mobile Applications</h2>
                </Fade>
                <Fade delay={700}>
                    <p className="my_desc">
            ...
            <section id="projects">
                ...
                <ProjectCard2
                    title="Speak And Share App"
                    desc="An ionic app to Translate and Share the spoken"
                    img_path={require("./assets/speak-and-share.jpg")}
                    tech_used={["Ionic", "React js", "Google API"]}
                    link="https://play.google.com/store/apps/details?id=com.shadowmind.speakandshare"
                />
                <ProjectCard
                    title="Front end work blog site."
                    desc="A Web App to learn and publish blogs."
                ...
                <ProjectCard
                    ...
                    desc="A Flutter app for managing all your todos, events, and get scheduled notifications."
                ...
                <ProjectCard
                    title="Alumni"
                    desc="A website for alumni of mechanical department students in JNTUACEP."
            ...
            <section id="contact">
                ...
                <p>
                    I'm currently looking for new oppurtunities, my inbox is always open. Whether you have a question or
                    just want to say hi, say hello!
                </p>
                <a href="mailto:chetanrule365@gmail.com" style={{ marginTop: "100px" }} className="button">
                    Say Hello
                </a>
            </section>
            <section className="social">
                <div className="social_links">
                    <Bounce>
                        <a target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/chetansaireddy/">
                            <img src={require("./assets/instagram.png")} alt="" />
                        </a>
                    </Bounce>
                    <Bounce delay={300}>
                        <a target="_blank" rel="noopener noreferrer" href="https://github.com/chetanrule365">
